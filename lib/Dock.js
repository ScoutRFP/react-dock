...
function getTransitions(duration) {
  return ['left', 'top', 'right', 'width', 'height'].map(function (p) {
...
var Dock = (_temp = _class = function (_Component) {
  ...
  _createClass(Dock, [{
    ...
    value: function render() {
      ...
      var outerClassNames = (0, _classnames2.default)('react-dock-outer-wrapper', this.props.outerContainerClassName);

      var innerClassNames = (0, _classnames2.default)('react-dock-inner-wrapper', this.props.innerContainerClassName);

      return _react2.default.createElement(
        'div',
        { className: outerClassNames, style: Object.assign({}, styles.wrapper, { zIndex: zIndex }) },
        dimMode !== 'none' && !isDimHidden && _react2.default.createElement('div', { style: dimStyles, onClick: this.handleDimClick }),
        _react2.default.createElement(
          'div',
          { className: innerClassNames, style: dockStyles },
